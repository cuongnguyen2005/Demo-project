...
import 'cate_expense_default_event.dart';
import 'cate_expense_default_state.dart';
import 'package:flutter_gen/gen_l10n/app_localizations.dart';

class CateExpenseDefaultBloc
    extends Bloc<CateExpenseDefaultEvent, CateExpenseDefaultState> {
  CateExpenseDefaultBloc() : super(CateDefaultInitial()) {
    on<CateExpenseDefaultEvent>((event, emit) {});
    on<CateGetExpenseDefaultEvent>((event, emit) {
      ...
      emit(CateExpenseDefaultState(categoryExpenseDfList: curListExpenseDf));
    });
  }
}
