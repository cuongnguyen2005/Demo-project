...
class CateIncome extends StatefulWidget {
  const CateIncome({super.key});
  static String routeName = 'cate_management';

  @override
  State<CateIncome> createState() => _CateIncomeState();
}

class _CateIncomeState extends State<CateIncome> {
  @override
  void initState() {
