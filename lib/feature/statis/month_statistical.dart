...
import 'package:finance_app/feature/statis/bloc/statis_bloc.dart';
...
class _MonthStatisticalPageState extends State<MonthStatisticalPage> {
  ...
  void groupFinanceByDay() {
    context.read<StatisBloc>().add(StatisGetMapMonthEvent(today: today));
  }
            ...
            children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(AppLocalizations.of(context)!.income,
                            style: tStyle.medium()),
                        Text(
                            '${NumberFormat.decimalPattern().format(state.totalIncomeMonth)} đ',
                    ...
                    Row(
                      ...
                      children: [
                        Text(AppLocalizations.of(context)!.expense,
                            style: tStyle.medium()),
                        Text(
                            '${NumberFormat.decimalPattern().format(state.totalExpenseMonth)} đ',
                    ...
                    Row(
                      ...
                      children: [
                        Text(AppLocalizations.of(context)!.inAndEx,
                            style: tStyle.medium()),
                        Text(
                            '${NumberFormat.decimalPattern().format(state.finalTotalMonth)} đ',
              ...
              Flexible(
                child: ListView.builder(
                  itemCount: state.sumMapMonth.length,
                  itemBuilder: (context, index) {
                    String key = state.sumMapMonth.keys.elementAt(index);
                    return Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            '${NumberFormat.decimalPattern().format(state.sumMapMonth[key])} đ',
                            style: tStyle.medium(),
                          ),
                        ],
                      ),
